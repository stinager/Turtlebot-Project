...
import roslib; roslib.load_manifest('demo_nav')
import rospy
import actionlib
...
class NavTest():
    def __init__(self):
        ...
        locations = dict()
        locations['porte_gauche'] = Pose(Point(-1.65444, 4.88183, 0.000), Quaternion(0.000, 0.000, 0.223, 0.975))
        locations['couloir_gauche'] = Pose(Point(-0.902092, 6.92778, 0.000), Quaternion(0.000, 0.000, 0.223, 0.975))
        locations['couloir_droite'] = Pose(Point(2.12858, 7.34538, 0.000), Quaternion(0.000, 0.000, 0.223, 0.975))
        ...
        while not rospy.is_shutdown():
            ...
            sequence = ['porte_gauche', 'couloir_gauche', 'couloir_droite']
